...
public class TestCustomerAdvanced {
	...
	@Test
	// Test that constructor correctly updates the attributes and get method returns
	// it:
	// attribute Id
	...
	public void testConstructorAttributeStatus() {
		...
		int exit = 8;
		Customer cust = new Customer(id, time, enter, exit); // new instance of Customer
		assertEquals(message, Customer.CUST_NOT_PROCESSED, cust.getStatus()); // expect status to be set to
																				// CUST_NOT_PROCESSED constant
	}

	@Test
	// Test that setStatus correctly updates the attributes and get method returns
	// it:
	...
	public void testConstructorMethodSetStatusValue1() {
		...
		assertEquals(message, Customer.CUST_ENTERED, cust.getStatus()); // expect status to be set to value of
																		// CUST_ENTERED
	}
	...
	public void testConstructorMethodSetStatusValue2() {
		...
		assertEquals(message, Customer.CUST_EXITED, cust.getStatus()); // expect status to be set to value of
																		// CUST_EXITED
	}
	...
	public void testArrivalNegativeValue() {
		try {
			...
			int exit = 8;
			new Customer(id, time, enter, exit); // new instance of Customer
			fail("Constructor should throw exception for invalid value of arrival"); // if get here no exception was
																						// thrown
		} catch (Exception e) {
			if (e instanceof IllegalArgumentException)
				assertTrue(true); // if here, caught exception
	...
	public void testEnterNegativeValue() {
		try {
			...
			int exit = 8;
			new Customer(id, time, enter, exit); // new instance of Customer
			fail("Constructor should throw exception for invalid value of enter"); // if get here no exception was
																					// thrown
		} catch (Exception e) {
			if (e instanceof IllegalArgumentException)
				assertTrue(true); // if here, caught exception
	...
	@Test
	// test that if status attribute is something other than one of the constants it
